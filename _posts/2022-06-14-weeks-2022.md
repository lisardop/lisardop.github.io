...
*Comparson between codices and digital treatments: A. Non retouched glyph 'Tecualoyan' in Codex Mendoza; B. 'Tecualoyan' in 500x500 paper-color background; C. Non-retouched glyph 'Tecualoyab' in Matrícula de Tributos; D. Same glyph colour-contrasted; E. Previous example cropped with a 500x500 paper-color background. F. Previous example mirrored.*
