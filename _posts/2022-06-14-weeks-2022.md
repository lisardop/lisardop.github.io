...
*As we can observe, any of them matches with Ahuatepec or Ahuatl examples from Mendoza. Background transparent or paper-colored are the most accurated when glyph is not artifical colored. When it is artificial colored, glyph matches with other trees and plants in a 'cross'-form, some water elements are present. Trees and plants-like-trees are very dificult to disting, even for human eye due to high combinations of peripheral elements, resulting in diferent names of tress or species.*
