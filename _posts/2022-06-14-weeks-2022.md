...
*As we can observe, none of them matches. Only last example, artificial colored matches with a frontal-face Otzotl with a hand in the right-top corner, but hand was erased from this test-example.*
