...
*As we can see, none of them match Ahuatepec or Ahuatl as in Mendoza (Except the full-green glyph and white background in the 2nd and 4th position where they surprisingly coincide). Transparent or paper-colored backgrounds are most accurate when the glyph has no artificial color. When artificially colored, the glyph matches other trees and plants in a 'cross' shape. Some water elements are present. Trees and tree-like plants are very difficult to distinguish, even for human eye due to the high complexity of peripheral elements, resulting in different names of trees or species.*
