...
This 2 weeks I am going to change previous code version, added new code for link images with Visual Lexicon entries (search results). Got glyph name from filename, and convert cosine distance into similarity percentage. All the code will be uploaded to Red Hen Lab server and here in my [2022 Github Repo](https://github.com/lisardop/GSoC2022)
