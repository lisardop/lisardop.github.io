...
Another temporal solution should be just get the glyph name in the first filename position an stablish a search-link, so user can check all available entries for Visual Lexicon:
