...
As the algorithm is determined by its color and shape position, we considered to frame (250x250 or 500x500) a couple of testing images, with a small margin and transparent background or emulating light-brown paper (from a JPG to a PNG  file, as is needed for transparency):
